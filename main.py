...
# ─── Version ──────────────────────────────────────────────────────────────────
BOT_VERSION = "Kurator 📀 Music Discovery Engine (v4.6.2)"
...
def _get_era_seed_artists(decades, skip_top=25, fetch=150):
    """
...
def _expand_era_pool(decades, depth=1):
    ...
    # Remove the seeds themselves to go deeper
    pool -= set(seeds)
...
def _filter_artists_by_decade(artists, decades, message=None):
    ...
    log.info("Era filter too restrictive — returning full pool")
    return pool
