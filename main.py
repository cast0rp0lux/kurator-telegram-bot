...
# ─── Version ──────────────────────────────────────────────────────────────────
BOT_VERSION = "Kurator 📀 Music Discovery Engine (v4.8.12)"
...
✦ KURATOR'S PICKS
Playlists curated from the creator's own listening history.
A real person's taste.

Choose how deep you go: Playlist, Dig or Rare.
Filter by decade before generating.

🧭 FREE EXPLORE
Navigate the music world freely.

Search any artist and explore their world.
Discover similar artists, styles and albums.

Browse by genre or tap your tag collection
to generate a playlist.

────────────────────────────────────
/clear — wipe your track history
...
def map_command(update, context):
    ...
    sent, timer = _working_message(msg, "🗺️ Still mapping…")
...
def handle_buttons(update, context):
    ...
    # ── decade_confirm: execute pending generation ────────────────────────────
        ...
        if gen_action == "playlist":
            ...
            sent, timer = _working_message(message, "🗺️ Still mapping…")
            if hops == 1:
