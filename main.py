...
# ─── Version ──────────────────────────────────────────────────────────────────
BOT_VERSION = "Kurator 📀 Music Discovery Engine (v3.8.0)"
...
def _format_artist_card(artist_query, info):
    """Clean artist card with flag, country, years."""
...
def _build_scene_buttons(artist_query, sorted_styles, info, chat_id):
    ...
    # Style list — up to 8, rest behind "more" button
