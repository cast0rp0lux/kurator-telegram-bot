...
# ─── Version ──────────────────────────────────────────────────────────────────
BOT_VERSION = "Kurator 📀 Music Discovery Engine (v4.9)"
...
def help_command(update, context):
    update.message.reply_text(_help_text(), parse_mode="Markdown")
...
def handle_buttons(update, context):
    ...
    if action == "cmd":
        ...
        if value == "menu":
            query.edit_message_text(f"{BOT_VERSION}\n\n*✦ Kurator's Picks* — Playlists from a real listening history.\n\n*🧭 Free Explore* — Navigate the music map freely.", parse_mode="Markdown", reply_markup=main_menu_markup())
            ...
            query.edit_message_text(_help_text(), parse_mode="Markdown",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🦍 Main menu", callback_data="cmd|menu")]]))
