...
# ─── Version ──────────────────────────────────────────────────────────────────
BOT_VERSION = "Kurator 📀 Music Discovery Engine (v3.9.5)"
...
def _export_buttons(key, map_chat_id=None):
    buttons = [
        [InlineKeyboardButton("📤 Export via Soundiiz", callback_data="soundiiz_help")],
...
Use /playlist <tag> for genre playlists.
...
def handle_buttons(update, context):
    ...
    # ── map_albums ────────────────────────────────────────────────────────────
        ...
        for album in albums:
            ...
            label  = f"{album['title'][:30]}{ep_tag}{year}"
            buttons.append([InlineKeyboardButton(
                label,
    ...
    # ── soundiiz_help: mini tutorial ──────────────────────────────────────────
    elif action == "soundiiz_help":
        query.edit_message_text(
            "📤 Export your playlist\n\n"
            "1. Go to soundiiz.com and create a free account\n\n"
            "2. Tap ··· and select\n"
            "   \"Import from plain text\"\n\n"
            "3. Paste your playlist\n\n"
            "4. Choose your platform —\n"
            "   Spotify, Qobuz, Apple Music and more",
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🌐 Open Soundiiz", url="https://soundiiz.com")],
                [InlineKeyboardButton("⬅ Back",           callback_data=f"export_back|{value}")],
            ])
        )
